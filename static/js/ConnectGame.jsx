...
function Board2(props) {
  var rows = []
  for(let i = 5; i>=0; i--){
    rows.push(<Row2 key = {i} row = {i} cells = {props.cells[i]} handleClick = {props.handleClick}/>)
  }
  return (
    <div>
      {rows}
  ...
  render(){
    return (
      <div>
        ...
        <Board2 cells = {this.state.cells} handleClick = {this.handleClick}/>
...
ReactDOM.render(
  <Game2/>,
  document.getElementById("ConnectGame2")
)